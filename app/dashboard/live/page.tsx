...
const OBJECTION_DB = [
  {
    ...
    nextMove: "Run a coverage gap audit. Ask what their current death benefit is vs their actual income replacement need.",
  },
  {
    ...
    nextMove: "Break the premium down to a daily cost. Anchor to what NOT being covered would cost their family.",
  },
  {
    ...
    nextMove: "Isolate the real objection — 'thinking about it' always hides another one. Dig deeper.",
  },
  {
    ...
    nextMove: "Schedule a 3-way call before hanging up. Get a specific date and time committed right now.",
  },
  {
    ...
    nextMove: "Reframe: ask them to put a number on what financial protection for their family is worth.",
  },
  {
    ...
    nextMove: "Find the emotional why. Ask who depends on them financially and make it concrete.",
  },
  {
    ...
    nextMove: "Get a specific callback time before ending the call. Don't hang up without a commitment.",
  },
  {
    ...
    nextMove: "Offer two specific times. Make it easy to say yes to one and lock in a time before hanging up.",
  },
]
