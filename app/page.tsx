        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "18px" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "6px" }}>
            <motion.div
              ...
              style={{ width: 8, height: 8, borderRadius: "50%", backgroundColor: "#142846", boxShadow: "0 0 8px #142846" }}
            />
            <span style={{ fontSize: "9px", letterSpacing: "0.22em", color: "#142846", textTransform: "uppercase", fontWeight: 700 }}>LIVE</span>
          </div>
        </div>
            ...
            <AnimatePresence>
              <motion.span
                ...
                style={{
                  ...
                  color: "#050B14", backgroundColor: "rgba(7,16,30,0.12)",
                  border: "1px solid rgba(7,16,30,0.3)",
...
function CellValue({ val }: { val: string | boolean }) {
  if (val === true)  return <span style={{ color: "#0B1B34", fontSize: "15px", fontWeight: 700 }}>✓</span>;
            ...
            {started && (
              <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
                <motion.div
                  ...
                  style={{ width: 7, height: 7, borderRadius: "50%", backgroundColor: "#0B1B34", boxShadow: "0 0 7px #0B1B34" }}
                />
                <span style={{ fontSize: "11px", fontWeight: 700, color: "#0B1B34", letterSpacing: "0.18em" }}>LIVE  {mins}:{secs}</span>
              </div>
            )}
                  ...
                  {visibleLines >= 3 && (
                    ...
                    >
                      ...
                      <div style={{ display: "flex", gap: "6px", flexWrap: "wrap" }}>
                        {[["DISC: S-Type", "#3B82F6"], ["Emotional Buyer", "#C9A84C"], ["Family Motivated", "#0B1B34"]].map(([label, color]) => (
    ...
    <div style={{ backgroundColor: BG, color: CREAM, fontFamily: "var(--font-space)" }}>
      ...
      >
        <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "0 32px", display: "flex", alignItems: "center", justifyContent: "space-between", height: "64px" }}>
          <span style={{ fontSize: "22px", fontWeight: 800, color: "#050B14", letterSpacing: "-0.5px" }}>SPEAR</span>
            ...
            <div style={{ flex: 1, maxWidth: "580px" }}>
              ...
              >
                <motion.div
                  ...
                  style={{ width: 7, height: 7, borderRadius: "50%", backgroundColor: "#142846", boxShadow: "0 0 6px #142846" }}
                />
              ...
              >
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  onClick={() => window.open("https://www.loom.com/share/8df62d6db79c4c06bae3e19c81b296e1", "_blank", "noopener,noreferrer")}
                  style={{
      ...
      <section style={{
        ...
        borderTop: `1px solid rgba(20,40,70,0.25)`,
        ...
        <Reveal>
          <div style={{ position: "relative", zIndex: 10, maxWidth: "600px", margin: "0 auto", textAlign: "center" }}>
            ...
            <p style={{ fontSize: "16px", color: "#C8D2E0", lineHeight: 1.75, marginBottom: "44px" }}>
