// All-party (two-party) consent states as of 2026.
// Recording a call without all-party consent in these states is illegal.
export const ALL_PARTY_CONSENT_STATES: readonly string[] = [
  "California",
  "Connecticut",
  "Delaware",
  "Florida",
...
// States with additional layered requirements beyond standard all-party
export const STATES_WITH_EXTRA_DISCLOSURE: readonly string[] = [
  "Florida", // Must obtain verbal agreement before recording
] as const;

// Partial area-code to state mapping for common US codes.
// Extend as needed — unknown codes default to requiring consent (safe default).
const AREA_CODE_STATE: Record<string, string> = {
  ...
  "850": "Florida", "863": "Florida", "904": "Florida", "941": "Florida",
  "954": "Florida",
  ...
  "331": "Illinois", "447": "Illinois", "464": "Illinois", "618": "Illinois",
  "630": "Illinois", "708": "Illinois", "773": "Illinois", "779": "Illinois",
  ...
  "701": "North Dakota",
  "216": "Ohio", "220": "Ohio", "234": "Ohio", "326": "Ohio",
  "330": "Ohio", "380": "Ohio", "419": "Ohio", "440": "Ohio",
  ...
  "484": "Pennsylvania", "570": "Pennsylvania", "582": "Pennsylvania",
  "610": "Pennsylvania", "717": "Pennsylvania", "724": "Pennsylvania",
  ...
  "210": "Texas", "214": "Texas", "254": "Texas", "281": "Texas",
  "325": "Texas", "346": "Texas", "361": "Texas", "409": "Texas",
  "430": "Texas", "432": "Texas", "469": "Texas", "512": "Texas",
  "682": "Texas", "713": "Texas", "726": "Texas", "737": "Texas",
  "806": "Texas", "817": "Texas", "830": "Texas", "832": "Texas",
...
/** Returns the US state name for a 10-digit phone number, or null if unknown. */
...
export type ConsentRequirement =
  | { required: false }
  | { required: true; state: string; florida: boolean; stateUnknown: boolean };

/** Returns the consent requirement for a given prospect state (or null = unknown). */
export function getConsentRequirement(prospectState: string | null): ConsentRequirement {
  if (prospectState === null) {
    // Unknown state — treat as requiring consent (safest default)
    return { required: true, state: "Unknown", florida: false, stateUnknown: true };
  }
  if (ALL_PARTY_CONSENT_STATES.includes(prospectState)) {
    return {
      required: true,
      state: prospectState,
      florida: prospectState === "Florida",
      stateUnknown: false,
    };
  }
